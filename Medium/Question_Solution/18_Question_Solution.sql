...
select dept_name, count(student_id) as student_number from department dp left join student st on dp.dept_id = st.dept_id
group by dept_name order by 2 desc, 1 asc